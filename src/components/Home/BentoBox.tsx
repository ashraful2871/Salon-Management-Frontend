      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div className="max-w-2xl">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-display text-slate-900 tracking-tight">
                    Premium Salon <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-gold">Experience</span>
                </h2>
            </div>
            <p className="text-slate-600 max-w-sm leading-relaxed font-medium">
                From classic cuts to luxury bridal packages, discover everything we offer through our network of elite professionals.
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 lg:row-span-2 relative overflow-hidden rounded-[2rem] bg-white border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-700 p-10 lg:p-12 group">
            ...
            <img src="https://i.ibb.co/L5QxPQ6/salon-interior.jpg" alt="Salon Interior" className="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-1000 -z-10" />
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-black font-display text-white mb-4 leading-tight">
                  Why Choose <br/>SalonKhuji?
                </h3>
                <p className="text-white/90 max-w-sm leading-relaxed font-medium text-lg drop-shadow-md">
                  We connect you with the finest salons and make booking an absolute breeze.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-white/30 bg-white/10 p-6 rounded-2xl backdrop-blur-xl">
                <div>
                  <div className="text-3xl font-black font-display text-white">500<span className="text-primary-300">+</span></div>
                  <div className="text-xs text-white/80 uppercase tracking-wider mt-1 font-semibold">Partners</div>
                </div>
                <div>
                  <div className="text-3xl font-black font-display text-white">50K<span className="text-primary-300">+</span></div>
                  <div className="text-xs text-white/80 uppercase tracking-wider mt-1 font-semibold">Clients</div>
                </div>
                <div>
                  <div className="text-3xl font-black font-display text-white">4.8<span className="text-gold">★</span></div>
                  <div className="text-xs text-white/80 uppercase tracking-wider mt-1 font-semibold">Rating</div>
                </div>
              </div>
            </div>
          </div>
